...
# load data
TrainData = np.load('../MNIST_data/partial_train_images.npy')
TrainLabels = np.load('../MNIST_data/partial_train_labels.npy')
TestData = np.load('../MNIST_data/partial_test_images.npy')
TestLabels = np.load('../MNIST_data/partial_test_labels.npy')
