...
# load data
TrainData = np.load('/Users/Sophie/Desktop/School Stuff/Budapest/Code/python-mnist/6and9_train_images.npy')
TrainLabels = np.load('/Users/Sophie/Desktop/School Stuff/Budapest/Code/python-mnist/6and9_train_labels.npy')
